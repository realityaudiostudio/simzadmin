  ...
  finally
  {
    ...
    const content=[
        ...
        },
        {
            ...
            icon:<svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
            <path d="M15.5 23.5083C18.3535 23.5083 20.6667 21.1951 20.6667 18.3417C20.6667 15.4882 18.3535 13.175 15.5 13.175C12.6465 13.175 10.3333 15.4882 10.3333 18.3417C10.3333 21.1951 12.6465 23.5083 15.5 23.5083Z" stroke="#450A0E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M13.485 18.4708L14.3246 19.3104C14.57 19.5558 14.9704 19.5558 15.2158 19.3233L17.515 17.205" stroke="#450A0E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.3333 28.4167H20.6667C25.8592 28.4167 26.7892 26.3371 27.0604 23.8054L28.0292 13.4721C28.3779 10.3204 27.4737 7.75 21.9583 7.75H9.04167C3.52625 7.75 2.62208 10.3204 2.97083 13.4721L3.93958 23.8054C4.21083 26.3371 5.14083 28.4167 10.3333 28.4167Z" stroke="#450A0E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.3333 7.75V6.71667C10.3333 4.43042 10.3333 2.58334 14.4667 2.58334H16.5333C20.6667 2.58334 20.6667 4.43042 20.6667 6.71667V7.75" stroke="#450A0E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
